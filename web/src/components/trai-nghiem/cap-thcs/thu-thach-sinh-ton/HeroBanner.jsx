  ...
  return (
    <section className="relative min-h-[85vh] w-full flex items-center justify-center overflow-hidden bg-slate-50 pt-[140px] pb-24 z-1 font-sans">
      ...
      <div 
        ...
        style={{ 
          backgroundImage: `url('${data?.bgImage || '/assets/images/trai-nghiem/cap-thcs/thu-thach-sinh-ton/hero_bg.png'}')` 
        }}
      />
      ...
      <div className="relative z-1 w-full max-w-5xl px-4 text-center">
        ...
        >
          ...
          >
            <span>
              <i className="ph-bold ph-compass text-abaBlue text-2xl" />
            </span>
          ...
          >
            {data?.subtitle || "Nơi các em học sinh bước vào hành trình tự lực cánh sinh từ những điều cơ bản nhất: tự tay nhóm lửa, lọc nước bằng các dụng cụ thô sơ tự chế, học kỹ năng định phương hướng và hoàn thành các thử thách đội nhóm cứu hộ."}
          </motion.p>
          ...
          >
            ...
            >
              ...
              <span>Địa điểm: <strong className="text-slate-700">Sân trường & Phòng học</strong></span>
            </motion.div>
          </motion.div>
