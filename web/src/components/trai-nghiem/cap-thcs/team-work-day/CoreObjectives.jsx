  ...
  const defaultObjectivesData = [
    {
      ...
      points: [
        "Tôn trọng sự khác biệt, hòa nhập để học hỏi và giúp đỡ nhau cùng phát triển.",
        "Kiên trì vượt khó khăn trong các hoạt động.",
        "Tuân thủ quy tắc trong thi đấu."
      ],
      description: "Xây dựng thái độ sống tích cực, tinh thần thể thao cao thượng và ý thức trách nhiệm cá nhân trong tổ chức tập thể."
    },
    {
      ...
      points: [
        "Kỹ năng lập kế hoạch, phân công nhiệm vụ, giải quyết vấn đề sáng tạo.",
        "Rèn luyện kỹ năng giao tiếp, hợp tác, làm việc theo nhóm trong các hoạt động tập thể."
      ],
      description: "Trang bị các kỹ năng xã hội cốt lõi giúp học sinh thiết lập mối quan hệ đồng nghiệp thu nhỏ và giải quyết mâu thuẫn đội nhóm."
    },
    {
      ...
      points: [
        "Linh hoạt, sáng tạo trong sử dụng công cụ.",
        "Rèn luyện kỹ năng vận động, thể lực."
      ],
      description: "Thực hành phối hợp tay mắt, rèn luyện sức bền thể chất thông qua việc vận hành các loại đạo cụ hơi lớn và đạo cụ liên hoàn."
    }
  ];
      ...
      <div className="container max-w-6xl mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-60 max-w-646 mx-auto">
          ...
          <p className="tw-text-base fw-medium text-slate-500 mb-0 mx-auto" style={{ fontSize: '16px', lineHeight: '1.6' }}>
            Chương trình được thiết kế bám sát chương trình giáo dục phổ thông mới của Bộ Giáo dục & Đào tạo, hướng tới 3 trụ cột phát triển toàn diện.
          </p>
        </div>
