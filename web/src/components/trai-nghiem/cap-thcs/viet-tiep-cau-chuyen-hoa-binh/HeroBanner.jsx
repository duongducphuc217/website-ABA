  ...
  return (
    <section className="relative min-h-[85vh] w-full flex items-center justify-center overflow-hidden bg-slate-50 pt-[140px] pb-24 z-1 font-sans">
      ...
      <div 
        ...
        style={{ 
          backgroundImage: `url('${data?.bgImage || '/assets/images/trai-nghiem/cap-thcs/viet-tiep-cau-chuyen-hoa-binh/hero_bg.png'}')` 
        }}
      />
      ...
      <div className="relative z-1 w-full max-w-5xl px-4 text-center">
        ...
        >
          ...
          >
            <span>
              <i className="ph-bold ph-flag text-abaBlue text-2xl" />
            </span>
            <span className="text-abaBlue">{data?.kicker || "Chương Trình Giáo Dục Địa Phương"}</span>
          </motion.div>

          {/* Main Title (H1) styled exactly like the homepage heading */}
          ...
          >
            {data?.subtitle || "Chương trình đặc biệt tìm hiểu về giai đoạn lịch sử đầy vẻ vang của dân tộc Việt Nam thông qua hoạt động trải nghiệm sôi động, đắp chiến lũy, bắn tên lửa, đưa xe tăng hơi, giúp khơi gợi lòng yêu nước."}
          </motion.p>
