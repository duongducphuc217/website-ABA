  ...
  const defaultObjectivesData = [
    {
      ...
      points: [
        "Bồi dưỡng thói quen chủ động ứng phó với các tình huống hỏa hoạn.",
        "Rèn luyện lòng dũng cảm, giữ được bình tĩnh trước hiểm nguy.",
        "Nâng cao tinh thần trách nhiệm bảo vệ bản thân và đồng đội."
      ],
      description: "Tôi luyện sự điềm tĩnh để đưa ra quyết định sáng suốt và hình thành thói quen kỷ luật tự giác khi có chuông báo cháy."
    },
    {
      ...
      points: [
        "Tăng cường ý thức tổ chức kỷ luật, luôn cảnh giác với các nguy cơ cháy nổ.",
        "Rèn luyện kỹ năng giao tiếp và hợp tác chặt chẽ trong các nhiệm vụ tập thể."
      ],
      description: "Thúc đẩy khả năng tự quản lý, tổ chức nhóm di tản trật tự và khả năng truyền tin, chỉ huy cứu trợ khẩn cấp."
    },
    {
      ...
      points: [
        "Rèn luyện kỹ năng quan sát thực địa và thực hiện đúng thao tác thoát hiểm khói.",
        "Biết cách sử dụng các phương tiện chữa cháy thông dụng (bình khí, bình bột).",
        "Thực hành kỹ thuật sơ cấp cứu băng bó cơ bản và rèn luyện thể lực vượt chướng ngại vật."
      ],
      description: "Làm chủ thao tác đu dây hạ chậm thoát hiểm tầng cao, kỹ thuật đi khom rờ tường trong phòng khói và sơ cứu y tế cơ bản."
    }
  ];
      ...
      <div className="container max-w-6xl mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-60 max-w-646 mx-auto">
          ...
          <p className="tw-text-base fw-medium text-slate-500 mb-0 mx-auto" style={{ fontSize: '16px', lineHeight: '1.6' }}>
            Huấn luyện kỹ năng sinh tồn thực tế giúp học sinh THCS ứng phó linh hoạt và bảo vệ an toàn tính mạng trước mọi sự cố cháy nổ hỏa hoạn.
          </p>
        </div>
