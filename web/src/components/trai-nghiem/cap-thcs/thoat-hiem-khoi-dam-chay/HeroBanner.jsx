  ...
  return (
    <section className="relative min-h-[85vh] w-full flex items-center justify-center overflow-hidden bg-slate-50 pt-[140px] pb-24 z-1 font-sans">
      ...
      <div 
        ...
        style={{ 
          backgroundImage: `url('${data?.bgImage || '/assets/images/trai-nghiem/cap-thcs/thoat-hiem-khoi-dam-chay/hero_bg.png'}')` 
        }}
      />
      ...
      <div className="relative z-1 w-full max-w-5xl px-4 text-center">
        ...
        >
          ...
          >
            <span>
              <i className="ph-bold ph-shield-warning text-abaBlue text-2xl" />
            </span>
          ...
          >
            {data?.subtitle || "Trang bị kiến thức, kỹ năng phòng cháy chữa cháy và thoát nạn an toàn cho học sinh theo Thông tư 06/2022/TT-BGDĐT. Giúp các em biết khom rờ tường thoát khói, đu dây thoát hiểm, dập lửa và sơ cứu."}
          </motion.p>
