  ...
  const defaultObjectivesData = [
    {
      ...
      points: [
        "Trách nhiệm: học sinh biết tự bảo vệ bản thân và hỗ trợ bạn bè dưới nước.",
        "Chăm chỉ: Rèn luyện tính kiên trì khi thực hành các kỹ năng an toàn.",
        "Yêu thiên nhiên: Hình thành ý thức bảo vệ nguồn nước và môi trường xung quanh."
      ],
      description: "Xây dựng thái độ tự lập an toàn, tinh thần trách nhiệm tập thể và nhận thức đúng đắn về tài nguyên nước thiên nhiên."
    },
    {
      ...
      points: [
        "Tự chủ và tự học: Biết đánh giá tình huống nguy hiểm liên quan đến nước và cách ứng phó.",
        "Giao tiếp và hợp tác: Phối hợp hiệu quả với bạn bè trong trò chơi vận động.",
        "Giải quyết vấn đề và sáng tạo: Ứng dụng kiến thức xử lý tình huống nguy cấp."
      ],
      description: "Nâng cao năng lực phản xạ, khả năng lãnh đạo đội nhóm và tinh thần đoàn kết vượt rào cản tập thể dưới nước."
    },
    {
      ...
      points: [
        "Kỹ năng an toàn nước: Nhận biết nguy cơ đuối nước, giữ bình tĩnh khi gặp sự cố.",
        "Bảo vệ môi trường nước: Ý thức giữ gìn nguồn nước sạch, tránh ô nhiễm và lãng phí.",
        "Rèn luyện phản xạ thăng bằng cơ thể và năng lực thể chất dưới nước."
      ],
      description: "Thực hành các kỹ năng sơ cấp cứu đuối nước, hô hấp nhân tạo, cách sử dụng các loại phao cứu sinh đúng tiêu chuẩn."
    }
  ];
      ...
      <div className="container max-w-6xl mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-60 max-w-646 mx-auto">
          ...
          <p className="tw-text-base fw-medium text-slate-500 mb-0 mx-auto" style={{ fontSize: '16px', lineHeight: '1.6' }}>
            Phát triển toàn diện phẩm chất sống có trách nhiệm, kỹ năng phòng vệ đuối nước và tinh thần bảo vệ môi trường nước cho học sinh THCS.
          </p>
        </div>
