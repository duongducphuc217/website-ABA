  ...
  return (
    <section className="relative min-h-[85vh] w-full flex items-center justify-center overflow-hidden bg-slate-50 pt-[140px] pb-24 z-1 font-sans">
      ...
      <div 
        ...
        style={{ 
          backgroundImage: `url('${data?.bgImage || '/assets/images/trai-nghiem/cap-thcs/water-safe-and-fun/hero_bg.png'}')` 
        }}
      />
      ...
      <div className="relative z-1 w-full max-w-5xl px-4 text-center">
        ...
        >
          ...
          >
            {data?.subtitle || "Giúp học sinh rèn luyện kỹ năng tự bảo vệ mình khi tiếp xúc với nước, phát triển tư duy sáng tạo, khả năng hợp tác đội nhóm và hình thành lối sống tích cực, bảo vệ môi trường nước."}
          </motion.p>
