  ...
  return (
    <section className="relative min-h-[85vh] w-full flex items-center justify-center overflow-hidden bg-slate-50 pt-[140px] pb-24 z-1 font-sans">
      ...
      <div 
        ...
        style={{ 
          backgroundImage: `url('${data?.bgImage || '/assets/images/trai-nghiem/cap-thcs/viet-len-muc-tieu/goals_hero_bg.png'}')` 
        }}
      />
      ...
      <div className="relative z-1 w-full max-w-5xl px-4 text-center">
        ...
        >
          ...
          >
            {data?.subtitle || "Truyền cảm hứng cho học sinh THCS tự tin kiến tạo mục tiêu cuộc sống, bứt phá giới hạn và gắn kết đồng đội."}
          </motion.p>
          ...
          >
            ...
            >
              ...
              <span>Địa điểm: <strong className="text-slate-700">Tại trường</strong></span>
            </motion.div>
          </motion.div>
