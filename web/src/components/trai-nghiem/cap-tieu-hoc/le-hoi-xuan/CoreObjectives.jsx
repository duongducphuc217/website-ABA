  ...
  const defaultObjectivesData = [
    {
      ...
      points: [
        "Bồi đắp tình yêu quê hương, yêu Tổ quốc và tự hào văn hóa dân tộc.",
        "Yêu thương, quan tâm và học cách chia sẻ tinh thần tết Việt sum vầy.",
        "Ý thức chấp hành nội quy, xếp hàng trật tự chờ tới lượt tham gia trạm."
      ],
      description: "Khơi dậy niềm tự hào văn hóa truyền thống ngày Tết dân tộc và tinh thần biết ơn cội nguồn lịch sử đất nước."
    },
    {
      ...
      points: [
        "Chủ động tự lập thực hiện các nhiệm vụ được phân công trong trạm.",
        "Kỹ năng hợp tác làm việc nhóm nhỏ, hỗ trợ bạn bè cùng vượt ải.",
        "Kỹ năng tự quản lý coupon cá nhân và tham gia giao thương lịch sự."
      ],
      description: "Rèn luyện khả năng giao tiếp cởi mở, giải quyết vấn đề linh hoạt và rèn luyện kỹ năng tự chủ cá nhân."
    },
    {
      ...
      points: [
        "Tìm hiểu các mốc lịch sử hào hùng qua trò chơi trải nghiệm mô phỏng.",
        "Nâng cao sự dẻo dai thể chất qua leo núi hơi, sâu hơi, kéo co, bao bố.",
        "Khai mở năng lực thẩm mỹ qua các gian nghệ thuật viết thư pháp, tò he."
      ],
      description: "Tiếp thu kiến thức lịch sử chiến thắng sông Như Nguyệt, Đông Bộ Đầu một cách trực quan sinh động nhất."
    }
  ];
      ...
      <div className="container max-w-6xl mx-auto px-4 relative z-10">
        <div className="text-center mb-60 max-w-646 mx-auto">
          ...
          <p className="tw-text-base fw-medium text-slate-500 mb-0 mx-auto" style={{ fontSize: '16px', lineHeight: '1.6' }}>
            Học sinh rèn luyện thể chất dẻo dai thông qua các trò chơi phao hơi lớn và củng cố kiến thức sử học sâu sắc qua các chặng lịch sử.
          </p>
        </div>
