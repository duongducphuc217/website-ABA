  ...
  const defaultObjectivesData = [
    {
      ...
      points: [
        "Bồi đắp tình yêu quê hương, đất nước, gia đình đoàn viên ấm áp.",
        "Hình thành tinh thần yêu thương, sẻ chia cùng bè bạn và mọi người.",
        "Trân trọng những giá trị văn hóa truyền thống của ngày Tết Trung Thu."
      ],
      description: "Tôi luyện lòng biết ơn lịch sử dân tộc, giáo dục tình yêu thương gia đình gắn kết và ý thức cộng đồng."
    },
    {
      ...
      points: [
        "Giải mã các câu đố hài hước của chú Cuội và chị Hằng trên sân khấu.",
        "Kỹ năng làm việc nhóm, phân chia công việc trong chặng làm đèn.",
        "Giao tiếp cởi mở, kết nối các thành viên lớp qua các trò chơi trúng thưởng."
      ],
      description: "Bồi dưỡng sự linh hoạt, kỹ năng tương tác phản xạ nhanh và sự tự tin thể hiện trước tập thể."
    },
    {
      ...
      points: [
        "Thẩm mỹ mỹ thuật: Thực hành tự làm đèn ông sao tre, lồng đèn giấy.",
        "Kỹ thuật thủ công: Thực hành nặn bánh dẻo trung thu bằng khuôn in hình.",
        "Vận động cơ bắp dẻo dai qua các trò chơi ném bóng, lâu đài hơi khổng lồ."
      ],
      description: "Rèn luyện tay nghề thủ công khéo léo (nặn tò he, in tranh Đông Hồ) và thể chất khỏe mạnh."
    }
  ];
      ...
      <div className="container max-w-6xl mx-auto px-4 relative z-10">
        <div className="text-center mb-60 max-w-646 mx-auto">
          ...
          <p className="tw-text-base fw-medium text-slate-500 mb-0 mx-auto" style={{ fontSize: '16px', lineHeight: '1.6' }}>
            Học sinh rèn luyện năng lực thẩm mỹ truyền thống qua chặng làm bánh làm đèn và duy trì sức bền vận động thể chất.
          </p>
        </div>
