  ...
  return (
    <section className="relative min-h-[85vh] w-full flex items-center justify-center overflow-hidden bg-slate-50 pt-[140px] pb-24 z-1 font-sans">
      <div 
        ...
        style={{ 
          backgroundImage: `url('${data?.bgImage || '/assets/images/trai-nghiem/cap-tieu-hoc/le-hoi-trung-thu/hero_bg.png'}')` 
        }}
      />
      ...
      <div className="relative z-1 w-full max-w-5xl px-4 text-center">
        ...
        >
          ...
          >
            ...
            <span className="text-abaBlue">{data?.kicker || "Lễ Hội Trải Nghiệm Giữa Thu Cho Bé"}</span>
          </motion.div>
          ...
          >
            ...
            <span className="text-warning-800">
              TRUNG THU GẮN KẾT - VUI TẾT ĐOÀN VIÊN
            </span>
              </>
            )}
          </motion.h1>
          ...
          >
            {data?.subtitle || "Khám phá tinh hoa văn hóa dân tộc và tham gia các trò chơi dân gian rực rỡ sắc màu. Cùng xem hoạt cảnh chú Cuội AI độc đáo, biểu diễn xiếc, nặn tò he và làm bánh dẻo ngon lành."}
          </motion.p>
