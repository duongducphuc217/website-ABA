  ...
  return (
    <section className="relative min-h-[85vh] w-full flex items-center justify-center overflow-hidden bg-slate-50 pt-[140px] pb-24 z-1 font-sans">
      <div 
        ...
        style={{ 
          backgroundImage: `url('${data?.bgImage || '/assets/images/trai-nghiem/cap-tieu-hoc/trai-nghiem-sang-tao/hero_bg.png'}')` 
        }}
      />
      ...
      <div className="relative z-1 w-full max-w-5xl px-4 text-center">
        ...
        >
          ...
          >
            <span>
              <i className="ph-bold ph-lightbulb text-abaBlue text-2xl" />
            </span>
            <span className="text-abaBlue">{data?.kicker || "Chương Trình Trải Nghiệm Sáng Tạo Học Đường"}</span>
          </motion.div>
          ...
          >
            {data?.subtitle || "“Trải nghiệm cùng ABA không cần phải đi xa!” Giúp học sinh rèn luyện kỹ năng giải quyết vấn đề, tinh thần đồng đội qua teambuilding phao hơi, khám phá nghệ thuật in tranh Đông Hồ và thực nghiệm khoa học."}
          </motion.p>
          ...
          >
            ...
            >
              ...
              <span>Thời gian: <strong className="text-slate-800">8h00 – 11h00 (1 buổi)</strong></span>
            </motion.div>
            ...
            >
              ...
              <span>Đối tượng: <strong className="text-slate-800">Học sinh Lớp 1 - 5</strong></span>
            </motion.div>
