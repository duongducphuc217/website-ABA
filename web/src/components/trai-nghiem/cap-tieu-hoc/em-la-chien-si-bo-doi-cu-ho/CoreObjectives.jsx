  ...
  const defaultObjectivesData = [
    {
      ...
      points: [
        "Hình thành tình yêu sâu sắc với lịch sử hào hùng của dân tộc.",
        "Thêm yêu mến, trân trọng hình ảnh các chú bộ đội Cụ Hồ.",
        "Nuôi dưỡng tinh thần đoàn kết, biết sẻ chia vì mục tiêu chung."
      ],
      description: "Bồi đắp tình cảm biết ơn Tổ quốc, ý thức kỷ luật tự giác và lòng tự hào dân tộc cho học sinh Tiểu học."
    },
    {
      ...
      points: [
        "Phát triển kỹ năng vận động thể chất dẻo dai qua các thử thách.",
        "Rèn luyện kỹ năng giao tiếp, hợp tác nhóm trong các bài tập quân sự.",
        "Tập thói quen tuân thủ mệnh lệnh và hỗ trợ đồng đội vượt khó."
      ],
      description: "Xây dựng sự năng nổ, tác phong nhanh nhẹn của chiến sĩ và rèn luyện kỹ năng phối hợp nhóm nhịp nhàng."
    },
    {
      ...
      points: [
        "Tăng hiểu biết về cuộc sống tập luyện, học tập của các chú bộ đội.",
        "Thực hành kỹ thuật gấp chăn màn vuông vức chuẩn quân đội Việt Nam.",
        "Thực hành băng bó cứu thương quân y, ném lựu đạn giả, bắn súng hơi laser."
      ],
      description: "Làm quen với các thao tác kỹ thuật quân sự cơ bản như dò mìn công binh, bắn súng hơi laser, vượt rào lưới ngụy trang."
    }
  ];
      ...
      <div className="container max-w-6xl mx-auto px-4 relative z-10">
        <div className="text-center mb-60 max-w-646 mx-auto">
          <div className="flex-align justify-content-center gap-8 mb-16 fw-semibold text-main-800 text-xl">
            ...
            <span className="text-abaBlue">MỤC TIÊU & Ý NGHĨA CỦA CHƯƠNG TRÌNH</span>
          </div>
          ...
          <p className="tw-text-base fw-medium text-slate-500 mb-0 mx-auto" style={{ fontSize: '16px', lineHeight: '1.6' }}>
            Học sinh được trải nghiệm thực tế đời sống quân ngũ, bồi dưỡng thể chất dẻo dai và ý thức kỷ luật tự giác cao.
          </p>
        </div>
