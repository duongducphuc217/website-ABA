  ...
  return (
    <section className="relative min-h-[85vh] w-full flex items-center justify-center overflow-hidden bg-slate-50 pt-[140px] pb-24 z-1 font-sans">
      <div 
        ...
        style={{ 
          backgroundImage: `url('${data?.bgImage || '/assets/images/trai-nghiem/cap-tieu-hoc/le-hoi-halloween/hero_bg.png'}')` 
        }}
      />
      ...
      <div className="relative z-1 w-full max-w-5xl px-4 text-center">
        ...
        >
          ...
          >
            <span>
              <i className="ph-bold ph-mask-happy text-abaBlue text-2xl" />
            </span>
            <span className="text-abaBlue">{data?.kicker || "Chương Trình Lễ Hội Trải Nghiệm Tiểu Học"}</span>
          </motion.div>
          ...
          >
            {data?.subtitle || "Đón một mùa lễ hội hóa trang Halloween rực rỡ sắc màu, vui nhộn và vô cùng sáng tạo. Trải nghiệm vẽ mặt nạ, chơi game trúng thưởng, xem kịch câm handmine và cuộc thi văn nghệ đặc sắc."}
          </motion.p>
          ...
          >
            ...
            >
              ...
              <span>Thời gian: <strong className="text-slate-800">17:30 - 19:30 (1 buổi)</strong></span>
            </motion.div>
