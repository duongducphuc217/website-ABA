  ...
  const defaultObjectivesData = [
    {
      ...
      points: [
        "Yêu thích, tự hào tìm hiểu về lịch sử quê hương, Tổ quốc Việt Nam.",
        "Hình thành tinh thần yêu thương, quan tâm và sẻ chia cùng bè bạn.",
        "Ý thức kỷ luật tập thể, nâng cao tinh thần đoàn kết vượt thử thách."
      ],
      description: "Truyền lửa tình yêu quê hương, đất nước, bồi đắp thói quen biết ơn lịch sử giữ nước của các thế hệ đi trước cho các em nhỏ."
    },
    {
      ...
      points: [
        "Biết cách lắng nghe và chủ động làm việc theo hướng dẫn của điều phối viên.",
        "Kỹ năng hợp tác nhóm nhỏ, phối hợp nhịp nhàng trong các trò chơi vận động.",
        "Kỹ năng giải quyết vấn đề sáng tạo trong các chặng thử thách giả định."
      ],
      description: "Xây dựng sự tự tin trước tập thể, rèn kỹ năng giao tiếp trao đổi ý kiến và kỹ năng tổ chức công việc đội nhóm."
    },
    {
      ...
      points: [
        "Kỹ năng khéo tay: Thực hành gấp mũ ca lô vệ quốc quân bằng giấy.",
        "Mở rộng kiến thức lịch sử địa phương Hà Nội qua hai cuộc kháng chiến chống Pháp, Mỹ.",
        "Rèn luyện thể lực tốt, sức bền và khả năng phối hợp vận động tay chân."
      ],
      description: "Tiếp thu kiến thức lịch sử trực quan qua hoạt động đắp chiến lũy cát, bắn tên lửa nước và đua xe tăng hơi."
    }
  ];
      ...
      <div className="container max-w-6xl mx-auto px-4 relative z-10">
        <div className="text-center mb-60 max-w-646 mx-auto">
          ...
          <p className="tw-text-base fw-medium text-slate-500 mb-0 mx-auto" style={{ fontSize: '16px', lineHeight: '1.6' }}>
            Chương trình thiết kế phù hợp với lứa tuổi Tiểu học giúp chuyển hóa các bài học lịch sử khô khan thành trải nghiệm vận động lý thú.
          </p>
        </div>
