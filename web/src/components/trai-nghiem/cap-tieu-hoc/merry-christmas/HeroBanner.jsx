  ...
  return (
    <section className="relative min-h-[85vh] w-full flex items-center justify-center overflow-hidden bg-slate-50 pt-[140px] pb-24 z-1 font-sans">
      <div 
        ...
        style={{ 
          backgroundImage: `url('${data?.bgImage || '/assets/images/trai-nghiem/cap-tieu-hoc/merry-christmas/hero_bg.png'}')` 
        }}
      />
      ...
      <div className="relative z-1 w-full max-w-5xl px-4 text-center">
        ...
        >
          ...
          >
            <span>
              <i className="ph-bold ph-tree-snowflake text-abaBlue text-2xl" />
            </span>
            <span className="text-abaBlue">{data?.kicker || "Chương Trình Trải Nghiệm Giáng Sinh Tiểu Học"}</span>
          </motion.div>
          ...
          >
            {data?.subtitle || "Hãy cùng Ông già Noel và Công chúa Tuyết đón Giáng sinh ấm áp với sự tham gia của các nghệ sĩ đặc biệt biểu diễn hề xiếc ảo thuật và đố vui nhận quà giáng sinh rực rỡ."}
          </motion.p>
          ...
          >
            ...
            >
              ...
              <span>Thời gian: <strong className="text-slate-800">90 phút (1 buổi)</strong></span>
            </motion.div>
