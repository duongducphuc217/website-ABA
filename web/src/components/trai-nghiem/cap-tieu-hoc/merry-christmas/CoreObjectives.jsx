  ...
  const defaultObjectivesData = [
    {
      ...
      points: [
        "Bồi dưỡng lòng nhân ái, sự sẻ chia yêu thương mùa Giáng sinh ấm áp.",
        "Gắn kết tình cảm bạn bè, thầy trò khăng khít qua không gian lễ hội.",
        "Kích hoạt cảm xúc hào hứng, tinh thần lạc quan trong học tập đầu năm mới."
      ],
      description: "Thúc đẩy các giá trị nhân văn cao đẹp, bồi dưỡng thói quen quan tâm, yêu thương và giúp đỡ mọi người xung quanh."
    },
    {
      ...
      points: [
        "Kỹ năng phản xạ nhanh trước các câu hỏi đố vui trên sân khấu lớn.",
        "Khả năng hợp tác, lắng nghe và tuân thủ kỷ luật đội nhóm tốt.",
        "Khả năng tương tác xã hội tự tin cùng các nghệ sĩ xiếc biểu diễn."
      ],
      description: "Tạo lập sân chơi lành mạnh giúp nâng cao sự tự tin và kỹ năng giao tiếp hòa đồng trước đám đông cho học sinh."
    },
    {
      ...
      points: [
        "Thẩm mỹ nghệ thuật: Thưởng thức biểu diễn nghệ thuật xiếc khỉ dí dỏm.",
        "Tiếp xúc khoa học: Khám phá màn biểu diễn xiếc lửa, tung hứng sáng tạo.",
        "Tư duy lô-gíc, phán đoán nhanh qua game bốc thăm may mắn nhận quà."
      ],
      description: "Nâng cao cảm thụ nghệ thuật sân khấu, bồi đắp tư duy quan sát nhạy bén và năng lực thể chất linh hoạt."
    }
  ];
      ...
      <div className="container max-w-6xl mx-auto px-4 relative z-10">
        <div className="text-center mb-60 max-w-646 mx-auto">
          ...
          <p className="tw-text-base fw-medium text-slate-500 mb-0 mx-auto" style={{ fontSize: '16px', lineHeight: '1.6' }}>
            Chương trình Giáng sinh kết hợp khéo léo nghệ thuật sân khấu đặc sắc giúp các bé Tiểu học vừa thư giãn vừa tích lũy kỹ năng.
          </p>
        </div>
