  ...
  const defaultObjectivesData = [
    {
      ...
      points: [
        "Bồi đắp tình yêu quê hương, yêu Tổ quốc và nét đẹp văn hóa Việt Nam.",
        "Yêu thương, quan tâm và học cách chăm sóc người thân trong gia đình.",
        "Trân trọng những giá trị thiêng liêng, sum vầy mỗi dịp Tết đến xuân về."
      ],
      description: "Khơi dậy lòng tự hào về văn hóa dân tộc và giáo dục đạo đức gia đình thông qua hoạt động gói bánh nghĩa tình."
    },
    {
      ...
      points: [
        "Chủ động tự làm được những việc được hướng dẫn từ điều phối viên.",
        "Tuân thủ các quy tắc ứng xử nơi công cộng, xếp hàng chờ tới lượt.",
        "Kỹ năng hợp tác nhóm, giao tiếp tự tin và kỹ năng giải quyết vấn đề."
      ],
      description: "Tôi luyện sự tự lập, kỷ luật tập thể và phát triển năng lực tương tác xã hội cho các bé Tiểu học."
    },
    {
      ...
      points: [
        "Thực hành gói hoàn chỉnh bánh chưng truyền thống bằng khuôn gỗ.",
        "Khám phá các câu chuyện lịch sử dân gian thông qua hoạt động văn nghệ.",
        "Thực hành kỹ năng chi tiêu tài chính cơ bản tại các gian trại chợ quê."
      ],
      description: "Bồi dưỡng sự khéo léo của đôi bàn tay, tư duy tài chính sơ khởi và cảm nhận văn hóa ngày Tết."
    }
  ];
      ...
      <div className="container max-w-6xl mx-auto px-4 relative z-10">
        <div className="text-center mb-60 max-w-646 mx-auto">
          ...
          <p className="tw-text-base fw-medium text-slate-500 mb-0 mx-auto" style={{ fontSize: '16px', lineHeight: '1.6' }}>
            Lễ hội bánh chưng mang đến những bài học thực hành kỹ năng bổ ích, giúp học sinh phát triển năng lực thể chất và thẩm mỹ truyền thống.
          </p>
        </div>
