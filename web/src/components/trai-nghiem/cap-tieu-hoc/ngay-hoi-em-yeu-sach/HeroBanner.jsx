...
const HeroBanner = ({ data }) => {
  ...
  return (
    <section className="relative min-h-[85vh] w-full flex items-center justify-center overflow-hidden bg-slate-50 pt-[140px] pb-24 z-1 font-sans">
      <div 
        className="absolute inset-0 bg-cover bg-center bg-no-repeat z-0 opacity-85 blur-[2px] transition-transform duration-[12000ms] hover:scale-102"
        style={{ 
          backgroundImage: `url('${data?.bgImage || '/assets/images/trai-nghiem/cap-tieu-hoc/ngay-hoi-em-yeu-sach/hero_bg.png'}')` 
        }}
      />
      ...
      <div className="relative z-1 w-full max-w-5xl px-4 text-center">
        ...
        >
          ...
          >
            <span>
              <i className="ph-bold ph-book-open-text text-abaBlue text-2xl" />
            </span>
            <span className="text-abaBlue">{data?.kicker || "Ngày Hội Trải Nghiệm Giáo Dục"}</span>
          </motion.div>
          ...
          >
            {data?.subtitle || "“Cuộc đời ta thay đổi theo hai cách: qua những người ta gặp và qua những cuốn sách ta đọc.” Đồng hành cùng các em xây dựng văn hóa đọc, bồi dưỡng tình yêu sách qua các trò chơi sáng tạo và góc trưng bày độc đáo."}
          </motion.p>
          ...
          >
            ...
            >
              <i className="ph-bold ph-clock text-abaBlue text-lg md:text-xl" />
              <span>Thời gian: <strong className="text-slate-800">180 phút (1 buổi)</strong></span>
            </motion.div>
            ...
            >
              ...
              <span>Đối tượng: <strong className="text-slate-800">Học sinh Tiểu học</strong></span>
            </motion.div>
            ...
            >
              ...
              <span>Địa điểm: <strong className="text-slate-700">Sân trường Tiểu học</strong></span>
            </motion.div>
          </motion.div>
