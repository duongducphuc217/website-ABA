  ...
  return (
    <section className="relative min-h-[85vh] w-full flex items-center justify-center overflow-hidden bg-slate-50 pt-[140px] pb-24 z-1 font-sans">
      <div 
        ...
        style={{ 
          backgroundImage: `url('${data?.bgImage || '/assets/images/trai-nghiem/cap-mam-non/trai-nghiem-ky-thu/hero_bg.png'}')` 
        }}
      />
      ...
      <div className="relative z-1 w-full max-w-5xl px-4 text-center">
        ...
        >
          ...
          >
            <span>
              <i className="ph-bold ph-lightbulb-filament text-abaBlue text-2xl" />
            </span>
            <span className="text-abaBlue">{data?.kicker || "Chương Trình Trải Nghiệm Học Đường Mầm Non"}</span>
          </motion.div>
          ...
          >
            {data?.subtitle || "Có ABA không phải đi xa! Chương trình dã ngoại thiết kế riêng cho các bé mầm non, mang đến thế giới vận động vui nhộn, sáng tạo nghệ thuật độc đáo và khám phá khoa học ống hút đầy thú vị."}
          </motion.p>
          ...
          >
            ...
            >
              ...
              <span>Thời gian: <strong className="text-slate-800">Cả ngày (Sáng & Chiều)</strong></span>
            </motion.div>
