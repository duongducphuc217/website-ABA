  ...
  return (
    <section className="relative min-h-[85vh] w-full flex items-center justify-center overflow-hidden bg-slate-50 pt-[140px] pb-24 z-1 font-sans">
      <div 
        ...
        style={{ 
          backgroundImage: `url('${data?.bgImage || '/assets/images/trai-nghiem/cap-mam-non/le-hoi-xuan/hero_bg.png'}')` 
        }}
      />
      ...
      <div className="relative z-1 w-full max-w-5xl px-4 text-center">
        ...
        >
          ...
          >
            ...
            <span className="text-abaBlue">{data?.kicker || "Ngày Hội Trải Nghiệm Văn Hóa Tết Cho Bé"}</span>
          </motion.div>
          ...
          >
            {data?.subtitle || "Nằm trong dự án gieo trồng văn hóa cổ truyền của ABA dành riêng cho trẻ mầm non. Bé được trải nghiệm nặn tò he nghệ thuật, in tranh Đông Hồ, làm xôi Đông Hồ và thỏa sức vui hội chợ quê kết nối yêu thương."}
          </motion.p>
          ...
          >
            ...
            >
              ...
              <span>Thời gian: <strong className="text-slate-800">8h00 – 16h00 (Cả Ngày)</strong></span>
            </motion.div>
