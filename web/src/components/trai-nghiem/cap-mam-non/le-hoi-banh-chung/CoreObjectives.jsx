  ...
  const defaultObjectivesData = [
    {
      ...
      points: [
        "Bồi đắp tình yêu quê hương, yêu Tổ quốc và nét đẹp văn hóa Việt.",
        "Yêu thương, quan tâm, chăm sóc những người thân yêu trong gia đình.",
        "Nuôi dưỡng bài học về tình yêu thương đồng bào sâu sắc từ thuở nhỏ."
      ],
      description: "Phát triển nhân cách tốt đẹp, khơi dậy niềm tự hào dân tộc và lòng biết ơn cội nguồn văn hóa Việt Nam."
    },
    {
      ...
      points: [
        "Tự làm được những việc được các anh chị hướng dẫn viên chỉ dạy.",
        "Tuân thủ các quy tắc chung, biết xếp hàng chờ tới lượt chơi trò chơi.",
        "Kỹ năng hợp tác chia sẻ nguyên liệu, kết nối bạn bè cùng lớp."
      ],
      description: "Rèn luyện tính tự lập bước đầu, ý thức kỷ luật tập thể và phát triển kỹ năng giao tiếp hòa đồng cho trẻ."
    },
    {
      ...
      points: [
        "Thực hành kỹ thuật gói bánh chưng truyền thống bằng khuôn gỗ.",
        "Khám phá lịch sử qua những câu chuyện dân gian và hoạt động văn nghệ.",
        "Nhận biết và giới thiệu được những nét đặc trưng cơ bản ngày Tết Việt."
      ],
      description: "Bồi dưỡng sự khéo léo của đôi tay (vận động tinh), tư duy thẩm mỹ cổ truyền và cảm quan về Tết xưa."
    }
  ];
      ...
      <div className="container max-w-6xl mx-auto px-4 relative z-10">
        <div className="text-center mb-60 max-w-646 mx-auto">
          ...
          <h2 className="fw-semibold heading-three text-slate-850 mb-20 font-heading">
            Phát Triển Năng Lực Cho Bé Mầm Non
          </h2>
          <p className="tw-text-base fw-medium text-slate-500 mb-0 mx-auto" style={{ fontSize: '16px', lineHeight: '1.6' }}>
            Giúp bé rèn luyện tính tự lập bước đầu, rèn luyện sự khéo tay qua cách gói bánh chưng gỗ cùng thầy cô và phụ huynh.
          </p>
        </div>
