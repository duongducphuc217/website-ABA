  ...
  const defaultObjectivesData = [
    {
      ...
      points: [
        "Bé tự tin hòa nhập thích nghi năng động với môi trường nước dã ngoại.",
        "Hình thành tinh thần yêu thương, giúp đỡ bạn bè cùng trạm chơi.",
        "Tập nếp sống tự giác kỷ luật xếp hàng lịch sự chờ tới lượt."
      ],
      description: "Thúc đẩy sự tự tin, lòng dũng cảm khi tiếp xúc với nước và giáo dục tính tự lập tập thể cho trẻ mầm non."
    },
    {
      ...
      points: [
        "Lắng nghe, tuân thủ tuyệt đối các quy tắc an toàn nước của MC.",
        "Hợp tác phối hợp nhịp nhàng trong chặng vận chuyển nước cùng nhóm.",
        "Giao tiếp vui vẻ cởi mở, gắn kết tinh thần đoàn kết đồng đội lớp."
      ],
      description: "Tôi luyện năng lực lắng nghe kỷ luật an toàn nước, khả năng giao tiếp cởi mở và tư duy phối hợp đội nhóm."
    },
    {
      ...
      points: [
        "Rèn kỹ năng khéo léo phối hợp tay mắt qua game câu cá, bắn súng hơi.",
        "Nâng cao sức khỏe thể chất cơ bắp dẻo dai qua cầu trượt nước.",
        "Cảm nhận giác quan đa dạng qua ma trận bong bóng xà phòng xốp."
      ],
      description: "Bồi dưỡng sự khéo léo kết hợp cơ bắp và phát triển giác quan phong phú cho bé qua làn nước mát lạnh."
    }
  ];
      ...
      <div className="container max-w-6xl mx-auto px-4 relative z-10">
        <div className="text-center mb-60 max-w-646 mx-auto">
          ...
          <p className="tw-text-base fw-medium text-slate-500 mb-0 mx-auto" style={{ fontSize: '16px', lineHeight: '1.6' }}>
            Giúp học sinh mầm non làm quen kỹ năng an toàn nước cơ bản và rèn luyện thể chất dẻo dai khỏe mạnh qua các trò chơi dưới nước.
          </p>
        </div>
