  ...
  return (
    <section className="relative min-h-[85vh] w-full flex items-center justify-center overflow-hidden bg-slate-50 pt-[140px] pb-24 z-1 font-sans">
      <div 
        ...
        style={{ 
          backgroundImage: `url('${data?.bgImage || '/assets/images/trai-nghiem/cap-mam-non/le-hoi-trung-thu/hero_bg.png'}')` 
        }}
      />
      ...
      <div className="relative z-1 w-full max-w-5xl px-4 text-center">
        ...
        >
          ...
          >
            ...
            <span className="text-abaBlue">{data?.kicker || "Lễ Hội Trải Nghiệm Giữa Thu Cho Bé Mầm Non"}</span>
          </motion.div>
          ...
          >
            {data?.subtitle || "Đưa bé bước vào thế giới thần tiên cổ tích với hoạt cảnh chú Cuội trốn thoát cú lừa ngoạn mục nhờ chị Hằng. Thưởng thức các màn trình diễn xiếc hài thú vị, đố vui giải mã bí ẩn và ảo thuật hấp dẫn."}
          </motion.p>
          ...
          >
            ...
            >
              ...
              <span>Thời gian: <strong className="text-slate-800">1 buổi (90 - 120 phút)</strong></span>
            </motion.div>
