  ...
  const defaultObjectivesData = [
    {
      ...
      points: [
        "Bồi đắp tình yêu quê hương, đất nước, gia đình gắn kết.",
        "Hình thành tinh thần yêu thương, chia sẻ, giúp đỡ bạn bè cùng lớp.",
        "Trân trọng những giá trị văn hóa truyền thống ngày hội trăng rằm."
      ],
      description: "Nuôi dưỡng tinh thần đoàn kết, sẻ chia yêu thương gia đình ấm áp và ý thức giữ gìn nét đẹp văn hóa Việt."
    },
    {
      ...
      points: [
        "Lắng nghe, trả lời các tình huống đố vui giải cứu chú Cuội dí dỏm.",
        "Phản xạ linh hoạt qua chuỗi trò chơi sân khấu 'Ai thông minh hơn Cuội'.",
        "Kỹ năng tự chủ và tuân thủ các quy tắc trật tự nơi đông người."
      ],
      description: "Rèn luyện khả năng giao tiếp cởi mở, tư duy nhạy bén giải quyết tình huống và tinh thần kỷ luật tập thể."
    },
    {
      ...
      points: [
        "Cảm nhận và phân biệt các nhạc cụ trống hội lân sư rồng tưng bừng.",
        "Phát triển kỹ năng thẩm mỹ thông qua việc làm quen đèn ông sao giấy.",
        "Giải phóng thể chất khỏe mạnh qua hoạt động nhảy dân vũ tập thể."
      ],
      description: "Thúc đẩy năng khiếu cảm thụ nghệ thuật âm nhạc trống hội cổ truyền và phát huy sự dẻo dai thể chất."
    }
  ];
      ...
      <div className="container max-w-6xl mx-auto px-4 relative z-10">
        <div className="text-center mb-60 max-w-646 mx-auto">
          ...
          <p className="tw-text-base fw-medium text-slate-500 mb-0 mx-auto" style={{ fontSize: '16px', lineHeight: '1.6' }}>
            Bé mầm non phát triển năng lực phản xạ nhanh và cảm nhận thẩm mỹ thông qua các tiết mục xiếc nghệ thuật đêm rằm.
          </p>
        </div>
