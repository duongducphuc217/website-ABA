  ...
  const defaultObjectivesData = [
    {
      ...
      points: [
        "Bồi đắp tình cảm yêu thương gia đình, chia sẻ ấm áp giáng sinh.",
        "Hình thành tinh thần đoàn kết, giúp đỡ bạn bè cùng trang lứa.",
        "Ý thức tham gia lễ hội an toàn, tự giác chấp hành luật chơi."
      ],
      description: "Tôi luyện sự ấm áp tình yêu thương, giáo dục tinh thần chia sẻ kết nối và ý thức cư xử lịch sự nơi công cộng."
    },
    {
      ...
      points: [
        "Phát triển kỹ năng lắng nghe câu chuyện Noel từ ông già tuyết.",
        "Rèn phản xạ nhanh nhẹn qua chuỗi trò chơi 'Siêu phản xạ'.",
        "Kỹ năng tự chủ và tập trung chú ý trước các màn xiếc hấp dẫn."
      ],
      description: "Thúc đẩy phát triển khả năng chú ý phản xạ nhanh, rèn luyện sự dạn dĩ thể hiện trước tập thể đông người."
    },
    {
      ...
      <div className="container max-w-6xl mx-auto px-4 relative z-10">
        <div className="text-center mb-60 max-w-646 mx-auto">
          ...
          <p className="tw-text-base fw-medium text-slate-500 mb-0 mx-auto" style={{ fontSize: '16px', lineHeight: '1.6' }}>
            Giúp học sinh mầm non phát triển năng lực phản xạ sân khấu, kích thích trí tò mò thẩm mỹ thông qua xiếc hề và xiếc thú.
          </p>
        </div>
