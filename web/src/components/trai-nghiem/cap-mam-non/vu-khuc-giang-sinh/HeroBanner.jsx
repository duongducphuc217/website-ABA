  ...
  return (
    <section className="relative min-h-[85vh] w-full flex items-center justify-center overflow-hidden bg-slate-50 pt-[140px] pb-24 z-1 font-sans">
      <div 
        ...
        style={{ 
          backgroundImage: `url('${data?.bgImage || '/assets/images/trai-nghiem/cap-mam-non/vu-khuc-giang-sinh/hero_bg.png'}')` 
        }}
      />
      ...
      <div className="relative z-1 w-full max-w-5xl px-4 text-center">
        ...
        >
          ...
          >
            <span>
              <i className="ph-bold ph-snowflake text-abaBlue text-2xl" />
            </span>
            <span className="text-abaBlue">{data?.kicker || "Chương Trình Lễ Hội Noel Cho Bé Mầm Non"}</span>
          </motion.div>
          ...
          >
            {data?.subtitle || "Không gian Giáng Sinh thần tiên diệu kỳ ngay tại trường! Bé được vui đùa cùng Ông già Noel và Công chúa Tuyết, xem xiếc hề tung hứng nghệ thuật, xiếc chó xiếc khỉ đáng yêu, và hóa thân Tôn Ngộ Không náo nhiệt."}
          </motion.p>
          ...
          >
            ...
            >
              ...
              <span>Thời gian: <strong className="text-slate-800">1 buổi (Chiều từ 13:45)</strong></span>
            </motion.div>
            ...
            >
              ...
              <span>Đối tượng: <strong className="text-slate-800">Học sinh Mầm non</strong></span>
            </motion.div>
            ...
            >
              ...
              <span>Địa điểm: <strong className="text-slate-700">Tại sân trường học</strong></span>
            </motion.div>
          </motion.div>
