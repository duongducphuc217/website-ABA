    ...
    >
      ...
      <div className='py-120'>
        <div className='container'>
          <div className='mx-auto text-center z-2' style={{ maxWidth: '900px' }}>
            <div className='mb-40'>
              <div
              ...
              <p className='fw-normal text-xl max-w-646 mx-auto text-center font-size-20-px wow bounceInUp'>
                Chúng tôi cam kết nuôi dưỡng tâm trí trẻ, trang bị cho các em
                kiến thức, kỹ năng và sự tự tin để vươn xa.
              </p>
            </div>
